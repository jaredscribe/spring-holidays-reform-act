# The Spring Holidays Reform Act

*Model bill text. Working draft, not reviewed by counsel. **Read the
[objections](#objections-and-how-this-draft-answers-them) before circulating
this.***
...
This Act may be cited as the *"Spring Holidays Reform Act"*.

## SEC. 2. FINDINGS.

Congress finds the following:

**(1)** The observance now known as Memorial Day arose from the practice of
...
## Objections, and how this draft answers them

Stated as an opponent would state them, not softened. A proposal this
...
**5. It conscripts Juneteenth into a purpose its constituency did not
request.** Making Juneteenth the national day of mourning for war dead invites
the charge that a young holiday is being made to carry a load the country
declined to keep carrying, and hands Juneteenth's opponents an argument that it
is displacing something. *Partially answered:* Sec. 5(b) is confined to the
Union dead of the war that ended slavery — a commemoration internal to
Juneteenth's own subject matter, not a general transfer of mourning. Whether
that distinction survives contact with a hearing is another question.

**6. There is an organized constituency, and it fights over far less than
...
## The alternative: the 1954 template

If the goal is to reconnect national commemoration to emancipation and to the
...
That version accomplishes the historical correction, creates scope language for
*both* holidays where neither has any, gives Juneteenth the section Pub. L.
117–17 never provided, and asks Congress to do something it has done before
